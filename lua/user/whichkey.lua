...
local mappings = {
  ...
  v = {
    name = "Testing",
    a = { "<cmd>Ultest<cr>", "All tests in file" },
  ...
  e = {
    name = "Errors",
    t = { "<cmd>TroubleToggle document_diagnostics<cr>", "Trouble Toggle (document)" },
    w = { "<cmd>TroubleToggle workspace_diagnostics<cr>", "Trouble Toggle (workspace)" },
